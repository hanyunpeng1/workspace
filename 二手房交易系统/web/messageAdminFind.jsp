...
<center>
    ...
    <table border="2px">
        ...
        <tr style="background-color: dodgerblue">
            ...
            %>
            <td style="border-style:none;"><%=message.getMessageId()%></td>
            ...
            <td style="border-style:none;">
                <a href="/myWeb/message/delete? messageId=<%=message.getMessageId()%>" target="right" style="text-decoration:none;">删除信息</a>
            </td>
        </tr>
        <%
            }
